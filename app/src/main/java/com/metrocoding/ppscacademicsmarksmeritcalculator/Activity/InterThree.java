...
public class InterThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_three);
        ...
        try {
            ...
            button_submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(checkid == -1)
                    {
                        Toast.makeText(InterThree.this, "Select Your Semester", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void send_final_Semester_Result() {
        ...
        if(value_semester !=0)
        {
            Intent intent = new Intent(getApplicationContext() , BscsThree.class);

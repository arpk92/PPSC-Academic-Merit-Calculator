...
public class MatricFourth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matric_fourth);
        ...
        try {
            ...
            button_submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(checkid == -1)
                    {
                        Toast.makeText(MatricFourth.this, "Select Your Semester", Toast.LENGTH_SHORT).show();
                    }
...
//                Toast.makeText(this, "30", Toast.LENGTH_SHORT).show();
    ...
    private void send_To_Intent()
    {
        if(value !=0)
        {
            Intent intent = new Intent(getApplicationContext() , InterFourth.class);
